...
const MODEL_GUIDES = {
    anima: "あなたはAnima向けの高品質画像生成プロンプト専門家です。\n\n" +
      ...
      "艶のある黒髪ロング、風になびく後れ毛、憂いを帯びた黒い瞳、長い睫毛、透明感のある白い肌、儚げな微笑み、\n" +
      ...
      "（3語の断片から髪質・表情・服装・光・背景の奥行きまで肉付けしている点に注目）",
    ...
    krea2: "あなたはKrea 2向けの高品質画像生成プロンプト専門家です。\n\n" +
      ...
      "【肉付けの実例】\n" +
      "入力アイデア「海辺に佇む黒髪の少女」→ 出力:\n" +
      "潮風になびく艶やかな黒髪の若い女性が、夕暮れの海辺に静かに佇んでいる。85mmポートレートレンズで撮影したような浅い被写界深度、ゴールデンアワーの温かい逆光が輪郭を縁取り、波打ち際には柔らかな反射光が広がる。もの悲しくも美しい、静謐な雰囲気。非常に精細で受賞歴のある写真のような品質、シネマティックなカラーグレーディング。\n" +
      "（3語の断片からレンズ・光・雰囲気まで具体的に描写を追加している点に注目）",
    ...
    gptImage2: "あなたはGPT Image 2向けの高品質画像生成プロンプト専門家です。\n\n" +
      ...
      "【肉付けの実例】\n" +
      "入力アイデア「海辺に佇む黒髪の少女」→ 出力:\n" +
      "長く艶やかな黒髪を潮風になびかせながら、波打ち際に裸足で静かに立つ若い女性。伏し目がちに水平線を見つめ、両手をそっと胸の前で組んでいる。夕暮れの砂浜を舞台にする。水平線に沈む夕日が空をオレンジと紫に染め、逆光が彼女のシルエットを縁取る。雰囲気はもの悲しくも美しく、静謐。フォトリアルなシネマティックスタイルで描写する。最高品質。\n" +
      "（3語の断片から視線・手の仕草・光の当たり方まで具体的に描写を追加している点に注目）",
    ...
    nanoBanana2: "あなたはNano Banana 2向けの高品質画像生成プロンプト専門家です。\n\n" +
      ...
      "【肉付けの実例】\n" +
      "入力アイデア「海辺に佇む黒髪の少女」→ 出力:\n" +
      "黒髪の若い女性, 波打ち際に静かに佇む, 潮風になびく髪, 夕暮れの砂浜, オレンジと紫のグラデーション空, 逆光のシルエット, もの悲しく美しいムード, シネマティック, ボリューメトリックライト, 高精細, 8K\n" +
      "（3語の断片から動作・光・ムードまで具体的なキーワードに分解している点に注目）",
    ...
    veo: "あなたはGoogle Veo向けの高品質AI動画生成プロンプト専門家です。\n\n" +
      ...
      "【肉付けの実例】\n" +
      "入力アイデア「海辺を歩く少女」→ 出力:\n" +
      "夕暮れの海岸線をゆっくりと歩く黒髪の若い女性, ローアングルからのゆったりとしたトラッキングショット, 波打ち際に反射する夕日, ゴールデンアワーの逆光, もの悲しくも美しいシネマティックな雰囲気, ハリウッド大作のような映像美, 4K, フォトリアル\n" +
      "（短いアイデアからカメラワーク・光・映像美まで肉付けしている点に注目）",
...
function mkGenPrompt(model, idea, fs, people) {
  ...
  return "【最優先の心構え: これは要約・言い換えのタスクではなく、創作のタスクです】\n" +
    "これから渡すアイデアやタグは、5〜20文字程度の短い断片に過ぎません。あなたの仕事は、そこから" + model.name + "が最高品質の" + (isVid?"映像":"絵") + "を作れるだけの情報量を持つ具体的なプロンプトを『創作』することです。\n" +
    "入力の単語をほぼそのまま並べ替えただけの出力は失敗と見なします。プロの" + (isVid?"映像ディレクター":"イラストレーター／フォトグラファー") + "が、クライアントから一言だけ依頼を受けて、そこから画角・光・質感・雰囲気を自分の裁量で考案するように取り組んでください。\n\n" +
    guide + "\n\n" + parts.join("\n\n") +
    "\n\n【肉付けの観点（入力に無くても必ず具体的な描写を追加すること）】\n" +
    "・光: 光源の方向、色温度、硬さ/柔らかさ、時間帯\n" +
    "・質感: 髪・肌・生地・空気感などのディテール\n" +
    "・構図: カメラの位置・角度・ショットサイズ\n" +
    "・雰囲気: そのシーンならではの空気感、感情の機微\n" +
    "・背景: 何が写り込んでいるか、奥行き\n\n" +
    "【厳守事項（最優先・他のどの指示より優先する）】\n" +
    "・アイデア、および「必ず反映する要素」に列挙されたタグは、1つの例外もなく最終的な出力の中に明示的な形で含めること。これはモデル別ルールの文字数・キーワード数の目安よりも優先する（目安を超えても構わないので、指定要素を絶対に削らないこと）。\n" +
    "・出力を確定する前に、アイデアと『必ず反映する要素』の一覧を1項目ずつ見直し、それぞれが文章中に反映されているか自己チェックすること。抜けている項目が1つでもあれば、必ず追加してから出力すること。\n" +
    "・そのうえで、指定されていない部分（光・質感・構図・雰囲気・背景など）にも積極的にディテールを創作して補うこと。\n" +
